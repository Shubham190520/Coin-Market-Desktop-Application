...
def my_portfolio():
    api_request = requests.get(
        "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=300&convert=USD&CMC_PRO_API_KEY=135e34cb-79b4-40df-8af3-be11f8a93d24")
    ...
    for i in range(0, 300):
        for coin in coins:
            if api["data"][i]["symbol"] == coin[1]:
                ...
                portfolio_id = Label(pycrypto, text=coin[0], bg="white", fg="black", font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
                ...
                no_coins = Label(pycrypto, text=coin[2], bg="white", fg="black", font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    add_coin = Button(pycrypto, text="Add Coin", bg="navyblue", fg="white", command=insert_coin,  font="Lato 12 bold", padx="5", pady="5",  borderwidth=2, relief="groove")
    ...
    update_coin_txt = Button(pycrypto, text="Update Coin", bg="navyblue", fg="white", command=update_coin,  font="Lato 12 bold", padx="5", pady="5",  borderwidth=2, relief="groove")
    ...
    delete_coin_txt = Button(pycrypto, text="Delete Coin", bg="navyblue", fg="white", command=delete_coin,  font="Lato 12 bold", padx="5", pady="5",  borderwidth=2, relief="groove")
    delete_coin_txt.grid(row=coin_row + 3, column=4, sticky=N + S + E + W)


    totalap = Label(pycrypto, text="${0:.2f}".format((total_amount_paid)), bg="white", fg="black", font="Lato 12 bold",padx="5", pady="5", borderwidth=2, relief="groove")
    totalap.grid(row=coin_row, column=4, sticky=N + S + E + W)

    totalcv = Label(pycrypto, text="${0:.2f}".format((total_current_value)), bg="white", fg="black", font="Lato 12 bold",padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    refresh = Button(pycrypto, text="Refresh", bg="navyblue", fg="white", command=reset,  font="Lato 12 bold", padx="5", pady="5",  borderwidth=2, relief="groove")
    refresh.grid(row=coin_row + 1, column=7, sticky=N + S + E + W)


def app_header():

    portfolio_id = Label(pycrypto, text="Portfolio ID", bg="navyblue", fg="white", font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
